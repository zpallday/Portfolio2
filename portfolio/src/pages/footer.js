    ...
    <footer className="footer text-center">
      <div className="text-center container mx-auto px-6 pt-10 pb-6">
        <div className="text-center flex flex-wrap">
          <div className="footer-h">
            <h2 className="footer-t">Want to reach out</h2>
          </div>
        </div>
      </div>
      <section class="container padding-title mx-auto px-5 p-10">
              <div className="links">
                ...
                <img className="link-gmail" src="https://i.ibb.co/z8PGwP1/iconfinder-gmail-1220367.png" alt="iconfinder-gmail-1220367" border="0"></img>
                </div>
      </section>
      <h5 className="footer-p">Copyright ©2020 Designed by Zachary</h5> 
    </footer>
  );
}
