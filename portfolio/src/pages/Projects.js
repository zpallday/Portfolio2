...
export default function NavBarLanding() {
  return (
    <div className="images-all">
      ...
      <a className="h1-project" href="https://illservesoup23.netlify.com/">  <img className="pics"  src="https://i.ibb.co/X3NLj9V/soup-3.png" alt="soup-3" border="0" width="50%" height="150" ></img></a>
      ...
      <a className="h1-project" href="https://theappofsplit.netlify.com/"> <img className="pics" src="https://i.ibb.co/z6LHgcd/spilt-3.png" width="50%" height="150" alt="split" border="0"></img></a>
      ...
      <a className="h1-project" href="https://staging.swaap.co/"> <img className="pics"  src="https://i.ibb.co/92cxYFF/staging-3.png" width="50%" height="150" alt="staging" border="0"></img></a>
